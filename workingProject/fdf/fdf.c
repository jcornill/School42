...
/*   Updated: 2016/03/24 11:15:12 by jcornill         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	for (int i = 0; i < 400; i++)
	{
	line = create_line(create_coord(0, i), create_coord(200, i),
	create_color(0, 0, 255, 0), create_color(255, 255, 0, 0));
	draw_line(window, line);
	line = create_line(create_coord(200, i), create_coord(400, i),
	create_color(255, 255, 255, 0), create_color(0, -255, -255, 0));
	draw_line(window, line);
	}
